...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print "Alerte! Punaises de lit"; ?></p>
    <div class="clear"></div>
    </div>
    <div id="pyro">
    	<p>Conception & réalisation par <a href="http://pyropixel.ca">Pyropixel | Studio web</a></p>
    </div>
  </div>
  </div>
</div>
